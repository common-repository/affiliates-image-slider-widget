<?php
/*
 * Plugin Name:		Affiliates Image Slider Widget
 * Plugin URI: 		https://www.techaid24.com
 * Description: 	Affiliates Image Slider Widget working from your Media Library in a Modern Responsive Slider with custom web address which you provide image caption. You can also added ALT and Description. Best plugins for boost your affiliate. 
 * Author: 		Selim Ahmed
 * Version: 		V1.9.2.0.001
...
/**
 * Adds Affiliates Image Slider Widget.
 */
class affiliates_image_slider_widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'affiliates-image-slider-widget-id', // Widget Base ID
                __('Affiliates Image Slider Widget', 'affiliates_image_slider_widget_techaid24'), // Widget Name
                array('description' => __('Affiliates Image Slider Widget working from your Media Library in a Modern Responsive Slider with custom web address which you provide image caption.', 'affiliates_image_slider_widget_techaid24'),) // Widget Description
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        $show_image_title = isset($instance['show_image_title']) ? (bool) $instance['show_image_title'] : false;
        $show_image_caption = isset($instance['show_image_caption']) ? (bool) $instance['show_image_caption'] : false;
        ...
        $autoplay_delay = isset($instance['autoplay_delay']) ? esc_attr($instance['autoplay_delay']) : '3500';
        $slider_pager = isset($instance['slider_pager']) ? (bool) $instance['slider_pager'] : false;
        $shuffle_images = isset($instance['shuffle_images']) ? (bool) $instance['shuffle_images'] : true;
        ...
        $lightbox_effect = isset($instance['lightbox_effect']) ? (bool) $instance['lightbox_effect'] : false;
        ...
        if (is_array($instance['thumbnail'])) :
                    ...
                    <div class="sp-slides">                        						
                        ...
                        foreach ($thumb_images as $thumb_image) :
                            ...
                            <div class="sp-slide">
                                ...
                                <?php /* Show Image and Lightbox - Custom URL Generator - Selim Ahmed */ ?>
                                <div class="misw-slider-image">
                                    <a href="<?php echo $thumb_image->post_excerpt; ?> " target="_blank"
                                    <?php
            ...
            if (is_home() && current_user_can('publish_posts')) :
                ...
                <div class="misw-slider-image-noimage">            
                    <?php printf(__('No selected images to display. <a href="%1$s">Select Images</a> or <a href="%2$s">Upload Images</a>. Need help?? Please read more <a href="https://techaid24.com">TechAid24</a> or <a href="mailto:support@techaid24.com">Mail Us</a>.', 'affiliates_image_slider_widget_techaid24'), esc_url(admin_url('widgets.php')), esc_url(admin_url('media-new.php'))); ?>
                </div>
                <?php
            else:
                ?>
                <div class="misw-slider-image-noimage">   
                    <?php printf(__('No selected images to display. Need help?? Please read more <a href="https://techaid24.com">TechAid24</a> or <a href="mailto:support@techaid24.com">Mail Us</a>.', 'affiliates_image_slider_widget_techaid24')); ?>
                </div>
            <?php
            endif;
        endif;
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'affiliates_image_slider_widget_techaid24'); ?></label>
            <input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $title; ?>" />
        </p>
        <h4>
            <?php printf(__('Slider Settings:', 'affiliates_image_slider_widget_techaid24')); ?>
        </h4>
        <p>
            ...
            <label for="<?php echo $this->get_field_id('show_image_title'); ?>"><?php _e('Display Image Title', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>		
        <p>
            ...
            <label for="<?php echo $this->get_field_id('show_image_caption'); ?>"><?php _e('Display Image Caption', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id('show_image_desc'); ?>"><?php _e('Display Image Description', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>		
        <p>
            ...
            <label for="<?php echo $this->get_field_id('autoplay_slider'); ?>"><?php _e('Enable Autoplay Slider', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('autoplay_delay'); ?>"><?php _e('Sets the delay at which the autoplay will run (1000 = 1second):', 'affiliates_image_slider_widget_techaid24'); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('slider_pager'); ?>"><?php _e('Display Slider Pager', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <h4>
            <?php printf(__('Advance Slider Settings:', 'affiliates_image_slider_widget_techaid24')); ?>
        </h4>
        <p>
            ...
            <label for="<?php echo $this->get_field_id('shuffle_images'); ?>"><?php _e('Shuffle Images', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id('image_fade'); ?>"><?php _e('Enable Image Fade', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('fade_delay'); ?>"><?php _e('Sets the fade delay duration (Default: 500):', 'affiliates_image_slider_widget_techaid24'); ?></label>
            ...
            <label for="<?php echo $this->get_field_id('lightbox_effect'); ?>"><?php _e('Disable LightBox Effect', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id('slider_arrow'); ?>"><?php _e('Remove Slider Arrow', 'affiliates_image_slider_widget_techaid24'); ?></label> 
        </p>
        <p>
            <label><?php _e('Order Image By', 'affiliates_image_slider_widget_techaid24'); ?></label>
        ...
        <p>
            <label><?php _e('Ascending(ASC) or Descending(DESC) Order', 'affiliates_image_slider_widget_techaid24'); ?></label>
        ...
        if ($attachments) :
            ?>
            <p>
                <?php printf(__('Select Images or <a href="%1$s">Upload Images</a>', 'affiliates_image_slider_widget_techaid24'), esc_url(admin_url('media-new.php'))); ?>
            </p>
            <?php
            $thumbnail = '';
            ...
            <div class="misw-media">
                <table>  
                    <tr>
                        <th class="misw-table-title"><label for="<?php echo $this->get_field_id('checkbox_all'); ?>"><?php _e('Select All:', 'affiliates_image_slider_widget_techaid24'); ?></label></th>
            ...
            ?>
            <p>
                <?php printf(__('No Images Found in Media Library. <a href="%1$s">Upload Here</a>.', 'affiliates_image_slider_widget_techaid24'), esc_url(admin_url('media-new.php'))); ?>
            </p>
        <?php
        endif;
    }
 ...
 *
 */
function affiliates_image_slider_widget_enqueue_scripts() {
...
add_action('wp_enqueue_scripts', 'affiliates_image_slider_widget_enqueue_scripts');

/**
 * Enqueue Admin Scripts
 *
 */
function affiliates_image_slider_widget_admin_enqueue_scripts() {
    wp_enqueue_style('affiliates-image-slider-widget-style-css', plugins_url('/assets/css/style.css', __FILE__));
}

add_action('admin_enqueue_scripts', 'affiliates_image_slider_widget_admin_enqueue_scripts');

/**
 * Register the Affiliates Image Slider Widget.
 *
 * Hooks into the widgets_init action.
 *
 */
function affiliates_image_slider_widget_load() {
    register_widget('affiliates_image_slider_widget');
}

add_action('widgets_init', 'affiliates_image_slider_widget_load');